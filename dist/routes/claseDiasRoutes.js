...
router.get("/clase-dias", authMiddleware_1.default, claseDiasController_1.default.getAllClaseDias);
router.get("/clase-dias/:id", authMiddleware_1.default, claseDiasController_1.default.getClaseDia);
router.put("/clase-dias/:id", authMiddleware_1.default, claseDiasController_1.default.updateClaseDia);
