...
router.post("/asistencias", authMiddleware_1.default, asistenciaController_1.default.getAllAsistencias);
router.post("/asistencias/detalle", authMiddleware_1.default, asistenciaController_1.default.getAsistencia);
